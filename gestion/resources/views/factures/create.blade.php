...
<form id="form_principale" action="{{ route('factures.store') }}" method="POST"
    ...
    <div id="etape1" class="etape active space-y-5">
        ...
        <div class="flex justify-between pt-6">
            ...
            <button type="button"
                    onclick="annulerForm()"
                    class="bg-gray-100 dark:bg-gray-700 hover:bg-red-500 dark:hover:bg-red-600 text-gray-600 dark:text-gray-200 hover:text-white px-6 py-3 rounded-xl transition-colors duration-300">
                Annuler
            </button>
        </div>
